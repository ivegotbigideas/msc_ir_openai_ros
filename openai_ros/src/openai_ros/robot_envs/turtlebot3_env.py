...
class TurtleBot3Env(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self):
        ...
        * /scan: Laser Readings
        ...
        Args:
        """
        print("Start TurtleBot3Env INIT...")
        ...
        print("Finished TurtleBot3Env INIT...")
    ...
    def move_base(self, linear_speed, angular_speed, epsilon=0.05, update_rate=10):
        ...
        print("TurtleBot3 Base Twist Cmd>>" + str(cmd_vel_value))
        self._check_publishers_connection()
