    ...
    def check_husarion_has_crashed(self, laser_readings):
        ...
        for laser_distance in laser_readings:
            ...
            if laser_distance == self.min_laser_value:
                ...
                rospy.logerr("Value of laser shouldnt be lower than min==>"+str(laser_distance)+", min="+str(self.min_laser_value))
            elif laser_distance > self.max_laser_value:
                rospy.logerr("Value of laser shouldnt be higher than max==>"+str(laser_distance)+", max="+str(self.min_laser_value))
